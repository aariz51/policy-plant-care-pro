...
class AppColors {
  ...
  // --- NEWLY ADDED (by previous instructions, keeping it) ---
  static const Color secondaryActionColor = Colors.blueGrey; // For SpeedDialChild backgrounds
  // --- END NEWLY ADDED ---
  ...
  static const Color textDarkPurple = Color(0xFF4A0072); // Dark purple for text, as required for loader
  static const Color textSecondary = Color(0xFF757575); // ADDED: Missing color constant

  // Background Colors
  static const Color background = Colors.white;
  static const Color scaffoldBackground = Color(0xFFF5F5F5); // A very light grey for general screen backgrounds
  static const Color backgroundAlt = Color(0xFFFAFAFA); // NEW: Alternative background, slightly different from scaffoldBackground or main background

  // Status/Semantic Colors
  static const Color success = Color(0xFF4CAF50);
  static const Color safeGreen = Color(0xFF2E7D32); // Example: A slightly darker green, or same as success
  static const Color warning = Color(0xFFFFC107);
  static const Color error = Color(0xFFF44336);
  static const Color avoidRed = Color(0xFFD32F2F); // NEW: Specific red for "avoid" scenarios, can be same as error or distinct. Using a common Material Design error red.
  static const Color info = Color(0xFF2196F3);
  static const Color premiumGold = Color(0xFFE4A400); // <<< ADDED AS PER AppDrawer REQUIREMENTS
  ...
  static const Color borderLight = Color(0xFFE0E0E0); // ADDED: Missing color constant
